...
<head>
    ...
    <link href="public/Styles/styleheader.css" rel="stylesheet">
    <link href="public/Styles/stylefooter.css" rel="stylesheet">
    <link href="public/Styles/styleform.css" rel="stylesheet">
    <link href="public/Styles/stylecart.css" rel="stylesheet">
</head>
...
<div class="doubleheader">
    ...
    <div class="container-fluid">
        <header class="d-flex flex-wrap align-items-center justify-content-around justify-content-md-around py-3">
            <a href="index.html"><img class="navlogo" src="Public/img/LOGO_AMAZEN-1.avif" alt="logo"></a>
            <div class="col-md-3">

                <!-- Button trigger modal -->
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
                    <img class="nav1" src="Public/img/geolocpic.png" alt="iconegeolocalisation">Me
                    géolocaliser
                </button>
